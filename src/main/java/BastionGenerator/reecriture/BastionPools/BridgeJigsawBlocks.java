...
public class BridgeJigsawBlocks {
    public static final HashMap<String, List<JigsawBlock>> JIGSAW_BLOCKS = new HashMap<>() {{
        ...
        this.put("jigsaws/bridge/connectors/back_bridge_bottom", Collections.singletonList(
        ...
        this.put("jigsaws/bridge/connectors/back_bridge_top", Collections.singletonList(
        ...
        this.put("jigsaws/bridge/bridge_pieces/bridge", Arrays.asList(
        ...
        this.put("jigsaws/bridge/starting_pieces/entrance", Arrays.asList(
        ...
        this.put("jigsaws/bridge/starting_pieces/entrance_base", Arrays.asList(
        ...
        this.put("jigsaws/bridge/starting_pieces/entrance_face", Collections.singletonList(
        ...
        this.put("jigsaws/bridge/legs/leg_0", Collections.singletonList(
        ...
        this.put("jigsaws/bridge/legs/leg_1", Collections.singletonList(
                new JigsawBlock(PoolType.EMPTY, JointType.ALIGNED, "leg_connector", "empty", BlockDirection.UP, BlockDirection.WEST, new BPos(0,21,1))
        ));
        this.put("jigsaws/bridge/rampart_plates/plate_0", Collections.singletonList(
        ...
        this.put("jigsaws/bridge/ramparts/rampart_0", Arrays.asList(
        ...
        this.put("jigsaws/bridge/ramparts/rampart_1", Arrays.asList(
                new JigsawBlock(PoolType.EMPTY, JointType.ALIGNED, "ramparts", "empty", BlockDirection.DOWN, BlockDirection.WEST, new BPos(0,0,0)),
        ...
        this.put("jigsaws/walls/wall_base_0", Arrays.asList(
        ...
        this.put("jigsaws/walls/wall_base_1", Arrays.asList(
