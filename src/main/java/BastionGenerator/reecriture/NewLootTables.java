...
public class NewLootTables {
    public static final LootTable BASTION_BRIDGE_CHEST_NEW = new LootTable(
            ...
            new LootPool(new UniformRoll(1.0F, 2.0F),
                    ...
                    new ItemEntry(Items.GOLDEN_AXE).apply(version -> SetCountFunction.constant(1)).apply(version -> new EnchantRandomlyFunction(Items.GOLDEN_AXE).apply(version))),
    ...
    public static final LootTable BASTION_HOGLIN_STABLE_CHEST_NEW = new LootTable(
            new LootPool(new ConstantRoll(1),
                    ...
                    new ItemEntry(Items.ANCIENT_DEBRIS, 12).apply(version -> SetCountFunction.constant(1)),
                    new ItemEntry(Items.ANCIENT_DEBRIS, 5).apply(version -> SetCountFunction.constant(2)),
                    new ItemEntry(Items.SADDLE, 12).apply(version -> SetCountFunction.constant(1)),
                    ...
                    new ItemEntry(Items.GOLDEN_APPLE, 10).apply(version -> SetCountFunction.constant(1))),
    ...
    public static final LootTable BASTION_OTHER_CHEST_NEW = new LootTable(
            new LootPool(new ConstantRoll(1),
                    ...
                    new ItemEntry(Items.ANCIENT_DEBRIS, 12).apply(version -> SetCountFunction.constant(1)),
                    new ItemEntry(Items.NETHERITE_SCRAP, 4).apply(version -> SetCountFunction.constant(1)),
                    new ItemEntry(Items.SPECTRAL_ARROW, 10).apply(version -> SetCountFunction.uniform(10.0F, 22.0F)),
                    new ItemEntry(Items.PIGLIN_BANNER_PATTERN, 9).apply(version -> SetCountFunction.constant(1)),
                    new ItemEntry(Items.MUSIC_DISC_PIGSTEP, 5).apply(version -> SetCountFunction.constant(1)),
                    new ItemEntry(Items.GOLDEN_CARROT, 12).apply(version -> SetCountFunction.uniform(6.0F, 17.0F)),
                    new ItemEntry(Items.GOLDEN_APPLE, 9).apply(version -> SetCountFunction.constant(1)),
            ...
            new LootPool(new ConstantRoll(2),
                    ...
                    new ItemEntry(Items.IRON_BLOCK, 2).apply(version -> SetCountFunction.constant(1)),
            ...
            new LootPool(new UniformRoll(3.0F, 4.0F),
                    ...
                    new ItemEntry(Items.COOKED_PORKCHOP).apply(version -> SetCountFunction.constant(1)))
    );
